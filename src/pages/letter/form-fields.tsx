  ...
  return (
    <Tabs defaultActiveKey="basic">
      <Tabs.TabPane tab="基础信息" key="basic">
        <Form.Item name="from" label="来源" rules={[{ required: true }]}>
        ...
        <Form.Item name="hintText" label="提示文本">
        ...
        <Form.Item name="mainAudio" label="主音频">
          <AlistMediaInput type="audio" placeholder="主音频" />
        </Form.Item>
        <Form.Item name="speed" label="打字速度(ms)">
          <InputNumber min={0} step={100} placeholder="请输入打字速度" />
        </Form.Item>
